...
public class ConsoleIO {
  ...
  public static void main(String[] args) {
     ...
     *   can get pretty gnarly, but we'll keep it simple today. Specifiers*/
    ...
    // Bonus Output with inputs and specifiers.
    System.out.println(String.format("'%s' is a sentence.\r\n'%s' is a string.\r\n%d is an integer.\r\n%g is a double.\r\n", sentence, word, integer, dub));
  }
